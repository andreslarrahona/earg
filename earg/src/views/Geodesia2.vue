    ...
    <div class="seccion">
      ...
      <div class="texto-2col">
        ...
        <div class="col-img" id="mapa-geodesia">
          <div id="sombra-geodesia" @click="imagenGeodesia = true">
            <p>
              AMPLIAR
        ...
        <div class="imagen-full" v-if="imagenGeodesia">
          <div class="sombra-full" @click="imagenGeodesia = false"></div>
          <div class="imagen-en-sombra">
            <img src="@/assets/images/geodesia.jpg">
          </div>
        </div>
      </div>
...
.imagen-full {
  ...
  .imagen-en-sombra {
    position: relative; // Needed for z-index to work relative to sombra-full
    z-index: 1001; // Ensure the image is above the overlay
    max-width: 70%; // Limit image width for responsiveness
    max-height: 90%; // Limit image height for responsiveness
    background-color: white; // Optional: A background for the image container
    padding: 1em; // Optional: Some padding around the image
    box-shadow: 0 0 20px rgba(0, 0, 0, 0.5); // Optional: Add a subtle shadow
