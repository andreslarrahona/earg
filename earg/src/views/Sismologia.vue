...
import contenido from '/CONTENIDO/Lineas de trabajo/Sismologia/Sismologia.json'
    ...
    <section class="contenedor" :class="{ 'fade-in': isMounted }">
        ...
        <div class="ppal-cards">
            ...
            <router-link 
                ...
                :to="card.enlace"
            >
                <img :src="`/CONTENIDO/Lineas de trabajo/Sismologia/${card.imagen}`" :alt="card.titulo">
                <h3>{{ card.titulo }}</h3>
